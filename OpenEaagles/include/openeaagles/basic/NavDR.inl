...
//==============================================================================
inline bool NavDR::getInvR0Matrix(
         const osg::Vec4d RPY,          // body roll, pitch, yaw [radians]
...
// Compute Wwt Matrix
//==============================================================================
inline bool NavDR::getWwtMatrix(
...
//==============================================================================
inline bool NavDR::getOmegaMatrix(
         const osg::Vec4d AV,           // body angular velocity [rps]
...
//==============================================================================
inline bool NavDR::getQuatDrMatrix(
         const double dT,               // time increment (secs)
         const osg::Vec4d AV,           // body angular velocity [rps]
         osg::Matrixd* const pDR
      )
...
// Compute Rwb Matrix
//==============================================================================
inline bool NavDR::getRwbMatrix(
         const double dT,               // time increment (secs)
         const osg::Vec4d RPY,          // body roll, pitch, yaw [radians]
         const osg::Vec4d AV,           // body angular velocity [rps]
